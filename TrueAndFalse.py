...
Original file is located at
    https://colab.research.google.com/drive/11ltp6dS-cZXshuyaurAHi75yW_703clc
"""
...
class GenerateFalseText :
  ...
  def generate_sentences(partial_sentence,full_sentence):
      ...
      top_3_sentences = GenerateFalseText.sort_by_similarity(full_sentence,generated_sentences)
